...
@Component({
  selector: 'app-aaacesa-salidas',
  templateUrl: './aaacesa-salidas.component.html',
  styleUrls: ['../../../scss/vendors/bs-datepicker/bs-datepicker.scss',
    '../../../scss/vendors/ng-select/ng-select.scss',
    '../../aaacesa/prealertas/prealertas.component.scss'],
  encapsulation: ViewEncapsulation.None 
})
export class AaacesaSalidasComponent {
